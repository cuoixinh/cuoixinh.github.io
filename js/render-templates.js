    ...
    .map((t, index) => {
      ...
      <div class="carousel-3d-card" data-index="${index}">
        <div class="art-template-card">
          <div class="relative h-full overflow-hidden rounded-[16px]" style="background:rgb(var(--surface-base-rgb));">
          ...
          <div class="art-template-overlay absolute bottom-0 left-0 right-0 pt-16 pb-4 px-4 rounded-b-[16px]"
            ...
            <span class="inline-flex items-center gap-1 rounded-full px-2 py-0.5 mb-2 text-[10px] font-semibold text-white" style="background:rgb(var(--surface-base-rgb)/0.22);backdrop-filter:blur(4px);">
            ...
            <div class="mt-3 flex gap-2" style="pointer-events:auto;">
              <button onclick="event.stopPropagation(); openPreview('${t.id}')"
                ...
                style="background:rgb(var(--surface-base-rgb)/0.85);color:rgb(var(--text-heading-rgb));border:1px solid rgb(var(--shadow-soft-rgb)/0.35);">
              ...
              <button onclick="event.stopPropagation(); createDraft('${t.id}')"
                ...
                style="pointer-events:auto;background:var(--brand-accent);">
