...
- **Trang Quản Trị**: Trang manage-by-customer.html nơi quản lý thông tin chi tiết của đám cưới
- **Trang Thiệp**: Trang index.html hiển thị thiệp cưới cá nhân hóa cho khách mời
...
```json
{
  ...
  "updates": [
    {"row": 2, "link": "http://domain.com/index.html?id=xxx&isGroom=true&name=xxx&relationship=xxx"},
    {"row": 3, "link": "http://domain.com/index.html?id=xxx&isGroom=true&name=yyy&relationship=yyy"},
    {"row": 4, "link": "http://domain.com/index.html?id=xxx&isGroom=true&name=zzz&relationship=zzz"}
  ]
}
```
...
1. Thêm script tag vào `manage-by-customer.html`
2. Thêm script tag vào `index.html`
