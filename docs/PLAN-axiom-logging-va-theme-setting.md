...
được ghi thành changelog có phiên bản: **`changelogs/RC01/schema/dqvinh_001_weddings.sql`** (cột `theme_setting`)
...
### Việc cần làm
- [x] Changelog DB (nay gộp vào `changelogs/RC01/schema/dqvinh_001_weddings.sql`) (áp dụng thủ công trên Supabase).
