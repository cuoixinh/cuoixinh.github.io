...
được ghi thành changelog có phiên bản: **`changelogs/RC1/RC1_003_theme_setting.sql`**
...
### Việc cần làm
- [x] Changelog DB `changelogs/RC1/RC1_003_theme_setting.sql` + cập nhật `changelogs/README.md` (áp dụng thủ công trên Supabase).
