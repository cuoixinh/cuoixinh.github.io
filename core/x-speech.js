...
(function (global) {
  ...
  if (!document.getElementById("x-speech-style")) {
    ...
    s.textContent = [
      ...
      "background:rgb(var(--surface-base-rgb));border-radius:20px;box-shadow:0 24px 60px rgb(var(--scrim-slate-rgb)/.3);",
      ...
      ".xsp-close:hover{background:rgb(var(--border-field-rgb));color:rgb(var(--action-dark-rgb))}",
      ...
      "background:linear-gradient(135deg,rgb(var(--ai-soft-from-rgb)),rgb(var(--ai-soft-to-rgb)));color:rgb(var(--text-inverse-rgb));display:inline-flex;",
      ...
      "background:rgb(var(--surface-base-rgb));color:rgb(var(--text-strong-rgb));font-size:12px;font-weight:600;cursor:pointer;",
      ...
      "background:var(--btn-dark-bg);color:rgb(var(--text-inverse-rgb));font-size:12px;font-weight:600;cursor:pointer;",
      "display:inline-flex;align-items:center;gap:8px}",
      ".xsp-apply:hover{background:var(--btn-dark-bg-hover)}",
