...
(function (global) {
  ...
  if (!document.getElementById("x-speech-style")) {
    ...
    s.textContent = [
      ...
      "justify-content:center;padding:16px;background:rgb(var(--slate-900-rgb)/.45);",
      ...
      "background:rgb(var(--white-rgb));border-radius:20px;box-shadow:0 24px 60px rgb(var(--slate-900-rgb)/.3);",
      ...
      ".xsp-title{font-size:16px;font-weight:700;color:rgb(var(--gray-800-rgb))}",
      ".xsp-close{width:28px;height:28px;border:none;background:rgb(var(--gray-100-rgb));color:rgb(var(--gray-500-rgb));",
      "border-radius:8px;display:inline-flex;align-items:center;justify-content:center;cursor:pointer;flex-shrink:0}",
      ".xsp-close:hover{background:rgb(var(--gray-200-rgb));color:rgb(var(--gray-900-rgb))}",
      ".xsp-close svg{width:16px;height:16px}",
      ".xsp-body{padding:0 16px 16px;overflow-y:auto}",
      ".xsp-q{margin-bottom:12px}",
      ".xsp-q-label{font-size:12px;font-weight:600;color:rgb(var(--rose-600-rgb));margin-bottom:8px}",
      ".xsp-q-list{display:flex;flex-direction:column;gap:4px}",
      ".xsp-q-item{font-size:12px;color:rgb(var(--gray-500-rgb));line-height:1.5;padding-left:16px;position:relative}",
      ".xsp-q-item::before{content:'•';position:absolute;left:4px;color:rgb(var(--rose-300-rgb))}",
      ".xsp-transcript{min-height:120px;max-height:240px;overflow-y:auto;border:1px solid rgb(var(--gray-200-rgb));",
      "border-radius:12px;padding:12px;font-size:12px;line-height:1.5;color:rgb(var(--gray-700-rgb));background:rgb(var(--gray-50-rgb));white-space:pre-wrap;word-break:break-word}",
      ".xsp-interim{color:rgb(var(--gray-400-rgb))}",
      ".xsp-placeholder{color:rgb(var(--steel-rgb))}",
      ".xsp-foot{display:flex;align-items:center;gap:12px;padding:12px 16px 16px;border-top:1px solid rgb(var(--gray-100-rgb))}",
      ...
      ".xsp-mic-pulse{position:absolute;inset:0;border-radius:9999px;background:linear-gradient(135deg,rgb(var(--violet-300-rgb)),rgb(var(--sky-400-rgb)));",
      ...
      "background:linear-gradient(135deg,rgb(var(--violet-300-rgb)),rgb(var(--sky-400-rgb)));color:rgb(var(--white-rgb));display:inline-flex;",
      "align-items:center;justify-content:center;box-shadow:0 8px 20px rgb(var(--indigo-500-rgb)/.35)}",
      ".xsp-mic svg{width:20px;height:20px}",
      ".xsp-status{flex:1;min-width:0;font-size:12px;color:rgb(var(--gray-500-rgb));white-space:nowrap;",
      "overflow:hidden;text-overflow:ellipsis}",
      ".xsp-actions{flex-shrink:0;display:inline-flex;align-items:center;gap:8px}",
      ".xsp-pause{box-sizing:border-box;height:40px;padding:0 16px;border:1px solid rgb(var(--gray-200-rgb));border-radius:12px;",
      "background:rgb(var(--white-rgb));color:rgb(var(--gray-700-rgb));font-size:12px;font-weight:600;cursor:pointer;",
      "display:inline-flex;align-items:center;gap:8px}",
      ".xsp-pause:hover{background:rgb(var(--gray-100-rgb))}",
      ...
      "background:rgb(var(--gray-900-rgb));color:rgb(var(--white-rgb));font-size:12px;font-weight:600;cursor:pointer;",
      "display:inline-flex;align-items:center;gap:8px}",
      ".xsp-apply:hover{background:rgb(var(--black-rgb))}",
