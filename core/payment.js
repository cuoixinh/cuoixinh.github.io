    ...
    step2.innerHTML = `
        <div class="flex flex-col items-center gap-2 p-6 text-center">
          ...
          <div class="text-center mb-1">
            ...
            <h3 class="font-playfair text-xl font-bold mb-1" style="color:rgb(var(--mauve-rgb));">Quét mã thanh toán</h3>
            <p class="text-xs text-gray-400">Sử dụng app ngân hàng để quét mã QR</p>
          </div>

          <!-- QR Code with decorative border -->
          <div class="from-pink-50 m-[8px] relative rounded-2xl to-white" style="border-color:rgb(var(--pink-100-rgb));">
            <div class="absolute -top-2 -left-2 w-5 h-5 border-t-[3px] border-l-[3px] rounded-tl" style="border-color:rgb(var(--pink-400-rgb));"></div>
            <div class="absolute -top-2 -right-2 w-5 h-5 border-t-[3px] border-r-[3px] rounded-tr" style="border-color:rgb(var(--pink-400-rgb));"></div>
            <div class="absolute -bottom-2 -left-2 w-5 h-5 border-b-[3px] border-l-[3px] rounded-bl" style="border-color:rgb(var(--pink-400-rgb));"></div>
            <div class="absolute -bottom-2 -right-2 w-5 h-5 border-b-[3px] border-r-[3px] rounded-br" style="border-color:rgb(var(--pink-400-rgb));"></div>
          ...
          <div class="w-full p-4 rounded-2xl bg-gradient-to-br from-gray-50 to-white border border-gray-100 shadow-sm">
            <div class="flex items-center gap-3 mb-3 pb-3 border-b-2" style="border-color:rgb(var(--pink-100-rgb));">
              <div class="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0" style="background:rgb(var(--pink-100-rgb));">
                <i class="fas fa-university text-base" style="color:rgb(var(--pink-400-rgb));"></i>
              </div>
              <div class="text-left">
                <p class="text-[11px] text-gray-400 uppercase tracking-wide font-semibold m-0">Thông tin chuyển khoản</p>
                <p class="text-sm font-semibold m-0" style="color:rgb(var(--mauve-rgb));">${paymentInfo.amount.toLocaleString("vi-VN")}đ</p>
              </div>
            </div>
            ...
            <div class="p-3 rounded-xl border border-dashed text-left" style="background:rgb(var(--pink-50-rgb));border-color:rgb(var(--pink-400-rgb));">
              <p class="text-[11px] text-gray-400 mb-1 font-medium">Nội dung chuyển khoản</p>
              <p class="text-xs font-bold break-all m-0" style="color:rgb(var(--mauve-rgb));">${paymentInfo.content}</p>
            </div>
          </div>

          <!-- Instructions -->
          <div class="w-full p-3.5 rounded-2xl border" style="background:rgb(var(--pink-150-rgb));border-color:rgb(var(--pink-100-rgb));">
            <div class="flex items-center gap-2 mb-2">
              <div class="w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0" style="background:rgb(var(--pink-400-rgb));">
                <i class="fas fa-mobile-alt text-white text-[11px]"></i>
              </div>
              <p class="text-xs font-semibold m-0" style="color:rgb(var(--mauve-rgb));">Hướng dẫn thanh toán</p>
            </div>
          ...
          <div class="flex flex-col items-center gap-2 mt-1">
            <div class="w-11 h-11 rounded-full bg-gradient-to-br from-pink-100 to-pink-50 flex items-center justify-center shadow-lg shadow-pink-200/30">
              <div class="w-5 h-5 border-[3px] rounded-full animate-spin" style="border-color:rgb(var(--pink-100-rgb));border-top-color:rgb(var(--pink-400-rgb));"></div>
            </div>
            <div class="text-center">
              <p class="text-xs font-semibold m-0" style="color:rgb(var(--mauve-rgb));">Đang chờ thanh toán...</p>
      ...
      try {
        ...
        if (qrcodeContainer && window.QRCode) {
          ...
          <div style="text-align:center;padding:32px;">
            <div style="width:48px;height:48px;border-radius:9999px;background:rgb(var(--red-bg-rgb));display:flex;align-items:center;justify-content:center;margin:0 auto 16px;">
              <i class="fas fa-exclamation-triangle" style="color:rgb(var(--red-fg-rgb));font-size:20px;"></i>
            </div>
            <p style="color:rgb(var(--red-fg-rgb));font-size:14px;margin:0 0 8px;font-weight:600;">Không thể tạo mã QR</p>
            <p style="color:rgb(var(--gray-500-rgb));font-size:12px;margin:0;">Vui lòng sử dụng nút thanh toán bên dưới</p>
          </div>
        `;
        }
      } catch (error) {
        ...
        if (qrcodeContainer) {
          qrcodeContainer.innerHTML = `
            <div style="text-align:center;padding:32px;">
              <div style="width:48px;height:48px;border-radius:9999px;background:rgb(var(--red-bg-rgb));display:flex;align-items:center;justify-content:center;margin:0 auto 16px;">
                <i class="fas fa-times-circle" style="color:rgb(var(--red-fg-rgb));font-size:20px;"></i>
              </div>
              <p style="color:rgb(var(--red-fg-rgb));font-size:14px;margin:0 0 8px;font-weight:600;">Lỗi tạo mã QR</p>
              <p style="color:rgb(var(--gray-500-rgb));font-size:12px;margin:0;">Vui lòng sử dụng nút thanh toán bên dưới</p>
            </div>
          `;
        }
        ...
        <div class="relative bg-white rounded-3xl max-w-[480px] w-full max-h-[90vh] shadow-2xl z-10 overflow-hidden">
          ...
          <div id="payment-step-1">
            <div class="p-6 border-b border-gray-100">
              <h3 class="font-playfair text-2xl font-bold m-0" style="color:rgb(var(--mauve-rgb));">Xác nhận đơn hàng</h3>
              <p class="text-sm text-gray-400 mt-1">Kiểm tra thông tin trước khi thanh toán</p>
            </div>
            <div class="p-6 flex flex-col gap-4">
              <!-- Thông tin mẫu -->
              <div class="flex items-center gap-4 p-4 rounded-2xl border border-pink-200" style="background:rgb(var(--pink-50-rgb));">
                <div class="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0" style="background:rgb(var(--pink-400-rgb));">
                  <i class="fas fa-envelope-open-text text-white text-lg"></i>
                </div>
                <div>
                  <p class="font-semibold text-sm m-0" style="color:rgb(var(--mauve-rgb));" id="payment-template-name">-</p>
                  <p class="text-xs text-gray-400 m-0">Thiệp cưới online</p>
                </div>
                <div class="ml-auto text-right">
                  <p id="payment-price" class="font-bold text-lg m-0" style="color:rgb(var(--mauve-rgb));">299.000đ</p>
                  <p id="payment-original-price" class="text-xs text-gray-300 line-through m-0">499.000đ</p>
                </div>
              </div>

              <!-- User info nếu đã đăng nhập -->
              <div id="payment-user-info" class="hidden items-center gap-3 p-3 rounded-2xl" style="background:rgb(var(--pink-50-rgb));">
                <img id="payment-avatar" src="" alt="" class="w-10 h-10 rounded-full object-cover border-2" style="border-color:rgb(var(--pink-400-rgb));" />
                <div>
                  <p class="text-sm font-medium m-0" style="color:rgb(var(--mauve-rgb));" id="payment-user-name-display"></p>
                  <p class="text-xs text-gray-400 m-0" id="payment-user-email-display"></p>
                </div>
                <i class="fas fa-check-circle ml-auto" style="color:rgb(var(--pink-400-rgb));"></i>
              </div>
              ...
              <div class="flex flex-col gap-1">
                <div class="flex gap-2">
                  ...
                  <button onclick="applyPromo()"
                    ...
                    style="background:rgb(var(--pink-100-rgb)); color:rgb(var(--mauve-rgb));">
                    Áp dụng
                  </button>
                </div>
              ...
              <div class="flex flex-col gap-1 py-3 border-t border-gray-100">
                ...
                <div class="flex items-center justify-between">
                  ...
                  <span id="payment-total-price" class="font-bold text-xl" style="color:rgb(var(--mauve-rgb));">299.000đ</span>
                </div>
              </div>

              <button onclick="PaymentModal.process()"
                class="w-full py-3.5 rounded-full text-white font-semibold text-sm border-0 cursor-pointer transition-colors hover:opacity-90" style="background:rgb(var(--rose-500-rgb));">
          ...
          <div id="payment-step-2" class="hidden p-12 flex-col items-center gap-6 text-center">
            <div class="w-16 h-16 rounded-full flex items-center justify-center" style="background:rgb(var(--pink-100-rgb));">
              <div class="w-8 h-8 border-4 border-pink-100 rounded-full animate-spin" style="border-top-color:rgb(var(--pink-400-rgb));"></div>
            </div>
            <div>
              <p class="font-semibold m-0" style="color:rgb(var(--mauve-rgb));">Đang xử lý thanh toán...</p>
          ...
          <div id="payment-step-3" class="hidden p-10 flex-col items-center gap-5 text-center">
            ...
            <div>
              <h3 class="font-playfair text-2xl font-bold mb-2 m-0" style="color:rgb(var(--mauve-rgb));">Thanh toán thành công!</h3>
            ...
            <div class="w-full p-4 rounded-2xl bg-gray-50 text-left">
              ...
              <p class="text-sm font-medium m-0" style="color:rgb(var(--mauve-rgb));" id="success-name"></p>
              <p class="text-xs text-gray-400 mt-1 m-0" id="success-phone"></p>
              <p class="text-xs text-gray-400 mt-2 m-0">Mẫu: <span id="success-template" class="font-medium" style="color:rgb(var(--mauve-rgb));"></span></p>
            </div>
            <!-- Link setup thiệp -->
            <div id="success-manage-block" class="w-full p-4 rounded-2xl border border-dashed text-left" style="border-color:rgb(var(--pink-400-rgb));background:rgb(var(--pink-50-rgb));">
              ...
              <div class="flex gap-2 items-center">
                ...
                <button onclick="copyManageLink()"
                  class="px-3 py-2 rounded-lg text-white border-0 cursor-pointer text-xs whitespace-nowrap flex-shrink-0" style="background:rgb(var(--rose-500-rgb));">
            ...
            <div class="flex gap-3 w-full">
              <button onclick="PaymentModal.close()"
                class="flex-1 py-3 rounded-full border-2 bg-white font-semibold text-sm cursor-pointer" style="border-color:rgb(var(--pink-400-rgb));color:rgb(var(--mauve-rgb));">
                Đóng
              </button>
              <a id="success-manage-btn" href="#"
                class="flex-1 py-3 rounded-full text-white font-semibold text-sm no-underline flex items-center justify-center gap-2" style="background:rgb(var(--rose-500-rgb));">
  ...
  window.PaymentModal = {
    open(templateName, theme, pricing = {}, existingManageId = null) {
      ...
      ["payment-name", "payment-phone", "payment-email"].forEach((id) => {
        ...
        document.getElementById(id).style.borderColor = "rgb(var(--gray-200-rgb))";
      });
    ...
    async process() {
      ...
      if (!name) {
        nameInput.style.borderColor = "rgb(var(--red-500-rgb))";
        nameErr.style.display = "block";
        hasError = true;
      } else {
        nameInput.style.borderColor = "rgb(var(--gray-200-rgb))";
      ...
      if (!phone) {
        phoneInput.style.borderColor = "rgb(var(--red-500-rgb))";
        phoneErr.style.display = "block";
        hasError = true;
      } else {
        phoneInput.style.borderColor = "rgb(var(--gray-200-rgb))";
        ...
        if (result.status === "completed") {
          ...
          if (timeoutEl) {
            ...
            if (msg) {
              ...
              msg.style.color = "rgb(var(--red-fg-rgb))";
            }
          }
        } else {
          // Still pending
