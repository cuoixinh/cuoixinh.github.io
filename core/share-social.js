...
(function (global) {
  ...
  const CHANNELS = [
    {
      key: "facebook", label: "Facebook", bg: "bg-[rgb(var(--social-facebook-rgb))]",
    ...
    {
      key: "messenger", label: "Messenger", bg: "bg-gradient-to-br from-[rgb(var(--social-messenger-from-rgb))] to-[rgb(var(--social-messenger-to-rgb))]",
    ...
    {
      key: "zalo", label: "Zalo", bg: "bg-[rgb(var(--social-zalo-rgb))]",
    ...
    {
      key: "whatsapp", label: "WhatsApp", bg: "bg-[rgb(var(--social-whatsapp-rgb))]", textInUrl: true,
