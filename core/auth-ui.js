...
(function () {
  ...
  const _HEART_SVG = `<svg viewBox="0 0 24 24" fill="#ec829e" class="w-5 h-5"><path d="M12 21s-6.716-4.297-9.428-7.01C.86 12.278.5 10.5 1.05 8.86A4.5 4.5 0 0 1 8.5 6.9l.5.5.5-.5a4.5 4.5 0 0 1 7.45 1.96c.55 1.64.19 3.42-1.52 5.13C18.716 16.703 12 21 12 21z"/></svg>`;
      ...
      <div data-auth-root>
        ...
        <div data-auth-step="email" class="space-y-2.5">
          ...
          <button type="button" data-auth-oauth="facebook" class="${_OAUTH_CLS}">
            <span style="color:#1877f2;display:flex">${_FB_SVG}</span> Tiếp tục với Facebook
          </button>
  ...
  function openModal(opts) {
    ...
    modal.innerHTML = `
      <div class="relative bg-white rounded-2xl w-full max-w-sm shadow-2xl overflow-hidden">
        ...
        <div class="h-1.5 bg-gradient-to-r from-[#ec829e] via-[#f4a0b8] to-[#ffb7ca]"></div>
        ...
        <div class="px-6 pt-6 pb-6">
          <!-- Trái tim -->
          <div class="w-12 h-12 mx-auto rounded-full flex items-center justify-center mb-3" style="background: rgb(254 241 247)">
            ${_HEART_SVG}
          </div>
          ...
          <div class="flex flex-wrap justify-center gap-2 mt-3.5 mb-5">
            <span class="inline-flex items-center gap-1.5 text-[11px] font-medium px-2.5 py-1 rounded-full" style="background:rgb(254 241 247);color:#be5a76">
            ...
            <span class="inline-flex items-center gap-1.5 text-[11px] font-medium px-2.5 py-1 rounded-full" style="background:#ecfdf3;color:#15803d">
