...
(function () {
  ...
  style.textContent = `
    #cx-tip {
      ...
      background: rgb(var(--surface-inverse-rgb)); color: rgb(var(--white-rgb));
      font-size: 12px; line-height: 1.5; font-weight: 500; font-family: inherit;
      border-radius: 8px; box-shadow: 0 4px 16px rgb(var(--scrim-rgb)/.24);
    ...
    #cx-tip[data-place="top"]::after    { top: 100%; left: var(--arrow-x, 50%); transform: translateX(-50%); border-top-color: rgb(var(--surface-inverse-rgb)); }
    #cx-tip[data-place="bottom"]::after { bottom: 100%; left: var(--arrow-x, 50%); transform: translateX(-50%); border-bottom-color: rgb(var(--surface-inverse-rgb)); }
    #cx-tip[data-place="left"]::after   { left: 100%; top: var(--arrow-y, 50%); transform: translateY(-50%); border-left-color: rgb(var(--surface-inverse-rgb)); }
    #cx-tip[data-place="right"]::after  { right: 100%; top: var(--arrow-y, 50%); transform: translateY(-50%); border-right-color: rgb(var(--surface-inverse-rgb)); }
