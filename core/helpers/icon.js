// Bảng icon lucide dùng chung cho TOÀN chương trình — path lấy từ lucide-static
// 0.544.0, nhúng thẳng nên không trang nào phải nạp thư viện icon.
//
//   HTML tĩnh:  <i data-icon="heart"></i>            ← tự dựng lúc DOM sẵn sàng
//               <i data-icon="heart" data-size="20" class="text-rose-500"></i>
//   Trong JS:   cxIcon("heart", 16, "text-rose-500") ← trả về chuỗi <svg>
//   HTML chèn động: gọi cxRenderIcons(root) sau khi chèn, hoặc dùng cxIcon().
//
// Thêm icon: copy phần bên trong <svg> của lucide vào CX_ICONS, tên giữ nguyên
// tên lucide. Kích thước mặc định 16px, màu theo currentColor.
...
// phải nhớ gọi cxRenderIcons ở từng chỗ chèn.
