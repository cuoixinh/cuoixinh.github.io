...
(function () {
  window.CX_THEME = {
    ...
    // khai thì helper tự dựng bộ màu từ hue của màu nhấn: bong bóng là lớp kính
    // màu nhạt (50%) phủ lên thiệp, chữ cùng sắc nhưng đậm — không bao giờ pha
    // đen/trắng; khai MỘT trong bubble/text/accent/btn là tắt hẳn phép tự tính,
    // mẫu phải tự lo cả bốn.
